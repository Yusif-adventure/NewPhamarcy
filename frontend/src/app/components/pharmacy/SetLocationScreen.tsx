...
type SetLocationScreenProps = {
  ...
  onBack: () => void;
  phone: string; // Need phone to identify user
};
    ...
    <div className="min-h-screen bg-white">
      <div className="p-6">
        ...
        <div className="flex flex-col items-center justify-center mt-24">
          ...
          <h2 className="mb-4 text-center">Confirm Pharmacy Location</h2>
          <p className="text-gray-600 text-center mb-8 px-4">
            Set your pharmacy location so customers can find you
          </p>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full bg-green-600 text-white py-5 px-6 rounded-xl shadow-lg flex items-center justify-center gap-2 disabled:opacity-70"
          >
            {isLoading ? (
              <>
